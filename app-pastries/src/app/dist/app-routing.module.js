...
var routes = [
    {
        path: 'pastries',
        component: pastries_component_1.PastriesComponent
    },
    {
        path: '',
        redirectTo: '/pastries',
    ...
    {
        path: 'login',
        component: pastrie_login_component_1.PastrieLoginComponent
    },
    {
        path: 'pastrie/:id',
        component: pastrie_description_component_1.PastrieDescriptionComponent
    },
];
